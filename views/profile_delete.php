...
<body>
    ...
    if (isset($_SESSION["user"]) == false) {
        ...
        // bejelentkezett ág
        // itt a form action processe a deleteProcess lesz, minden mező disabled
        // gomblenyomás esetén kérdezzen rá mégegyszer? pl modal
    ?>
        ...
        <main class="container-lg py-5 main-custom-top">
            ...
            <section class="row row-cols-1 gy-3 py-3">
                <article class="col-auto p-2 mx-auto">
                    <h1 class="p-2 rounded-2 bg-light">Felhasználói fiók törlése</h1>
                </article>
                <article class="col-lg-8 p-2 mx-auto">
                    <form action="?page=profileDeleteProcess" method="post" class="container rounded-2 bg-light">
                        <div class="row gy-3 justify-content-center">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" value="<?php echo $user["password"] ?>" disabled>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="billing_name" name="billing_name" value="<?php echo $user["billing_name"] ?>" disabled>
                            </div>
                            <div class="col-12">
                                <label for="country">Ország</label>
                                <input type="text" class="form-control" id="country" name="country" value="<?php echo $user["country"] ?>" disabled>
                            </div>
                            <div class="col-lg-6">
                                <label for="zip">Irányítószám</label>
                                <input type="text" class="form-control" id="zip" name="zip" value="<?php echo $user["zip"] ?>" disabled>
                            </div>
                            <div class="col-lg-6">
                                <label for="city">Város</label>
                                <input type="text" class="form-control" id="city" name="city" value="<?php echo $user["city"] ?>" disabled>
                            </div>
                            <div class="col-lg-6">
                                <label for="street">Utca</label>
                                <input type="text" class="form-control" id="street" name="street" value="<?php echo $user["street"] ?>" disabled>
                            </div>
                            <div class="col-lg-6">
                                <label for="nr">Házszám</label>
                                <input type="text" class="form-control" id="nr" name="nr" value="<?php echo $user["nr"] ?>" disabled>
                            </div>
